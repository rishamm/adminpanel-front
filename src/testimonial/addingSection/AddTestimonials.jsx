...
import { fetchTestimonial, postTestimonial, updateTestimonial, } from "../../action/homeAction"



const AddTestimonials = (closeModal, mode, card) => {
    ...
    const onFieldChange = (key, value) => {
      ...
      const handleSave = () => {
        ...
        if (mode === 'add') {
            ...
            updateTestimonial(formData, card._id)
            .then((response) => {
              if (response.data.success) {
                enqueueSnackbar(response.data.message, { variant: 'success', anchorOrigin: { vertical: 'top', horizontal: 'right' } });
                setOpen(false);
