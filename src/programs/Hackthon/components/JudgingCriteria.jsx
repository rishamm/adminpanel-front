...
import AddjudgCrtria from '../addingSection/AddjudgCrtria';

const JudgingCriteria = () => {
    const communities = [
        { id: 1, criteria: 'Use of industry experts'},
        { id: 2, criteria: 'Clarity of idea'},
        { id: 3, criteria: 'Skill and thoroughness'},
        { id: 4, criteria: 'International collaboration'},
    ];
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell className="text-left">Criteria</TableCell>
                    ...
                    <TableBody>
                        {communities.map((community, index) => (
                            <TableRow key={community.id}>
                                ...
                                <TableCell className="text-left">{community.criteria}</TableCell>
